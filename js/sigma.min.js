    ...
    function Sigma(root, id) {
        ...
        this.mousecaptor.bind('drag interpolate', function(e) {
            ...
            if (targeted.length) {
                ...
                if(cursor_size>0 && e.type=="mousedown") {/**/
...
//                    pr(is_empty(selections));
                    ...
                    if(is_empty(actualSel)==true || i==0){ 
                        ...
                        for(var i in actualSel) getOpossitesNodes(actualSel[i],false);  
                        greyEverything();
                        for(var i in actualSel) markAsSelected(actualSel[i],true); 
